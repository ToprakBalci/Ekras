...
Proje, modern kentsel yaşamı doğayla buluşturan bir konseptle tasarlanmıştır.`,
  ...
  {
    id: "proje-linki-buraya", // URL'de görünecek kısım. Türkçe karakter ve boşluk olmadan yaz! (Örn: vela-sapanca)
    title: "Proje Adı Buraya", // Sitede görünecek büyük başlık (Örn: Vela Sapanca)
    location: "İlçe / İl", // Konum bilgisi (Örn: Sapanca / Sakarya)
    image: "images/ana-resim.jpg", // Kartın üzerinde görünecek ana resmin images klasöründeki adı
    description: `Buraya proje hakkında istediğin kadar uzun açıklama yazabilirsin.
Alt satıra geçmek için Enter'a basman yeterli, buradaki tırnak işareti (backtick) bunu destekler.`,
    specs: {
      "Proje Türü": "Villa / Rezidans / Apartman", // Değiştir
      "Konut Sayısı": "12 Adet Konut", // Değiştir
      "Arsa Alanı": "10.000 m²", // Gerek yoksa bu satırı komple silebilirsin
      "İnşaat Alanı": "5.000 m²", // Gerek yoksa bu satırı komple silebilirsin
      "Oda Sayısı": "4+1 / 5+1", // Değiştir
      "Başlangıç": "2025", // Değiştir
      "Tamamlanma": "2026", // Değiştir
      "Konum": "İlçe / İl" // Değiştir
    },
    gallery: [
      "images/galeri-resim-1.jpg", // Detay sayfasında görünecek 1. resim
      "images/galeri-resim-2.jpg", // Detay sayfasında görünecek 2. resim
      "images/galeri-resim-3.jpg"  // İstediğin kadar resim ekleyebilirsin
    ]
  }
];
