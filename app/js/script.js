...
document.addEventListener('DOMContentLoaded', function() {
     ...
     */
    // ============================================================
    // 10. SCROLL-REVEAL ANIMATIONS (Düzeltildi)
    // ============================================================
    ...
    // .project-card buradan çıkarıldı, böylece kartlar görünmez olmaktan kurtuldu
    const revealElements = document.querySelectorAll(
        '.service-card, .gallery-item, .about-text, .about-image, .contact-info-item'
    );
    ...
    serviceCards.forEach(card => {
        card.addEventListener('click', function() {
            ...
            showToast(`"${title}" hizmeti detay sayfasına yönlendiriliyorsunuz...`);
        });
    });
